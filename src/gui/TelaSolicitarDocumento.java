		...
		if(conta.getUsuario() instanceof Aluno){
			...
			btnConfirmar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if(escolhido.equals("Comprovante de Matricula")){
					...
					else if(escolhido.equals("Diploma para Graduação")){
					...
					else if(escolhido.equals("Diploma para Pós Graduação")){
					...
					else if(escolhido.equals("Histório Completo da Graduação")){
					...
					else if(escolhido.equals("Histórico Completo da Pós Graduação")){
					...
					else if(escolhido.equals("Certificado de Conclusão de Curso")){
						...
						else  if(escolhido.equals("Transferencia Para Outra Instituição")){
